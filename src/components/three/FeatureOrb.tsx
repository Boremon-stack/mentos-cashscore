  ...
  return (
    <group ref={ref}>
      <mesh>
        ...
        <meshStandardMaterial color="#3968c9" emissive="#16264d" emissiveIntensity={0.6} roughness={0.3} metalness={0.5} />
      </mesh>
    </group>
  );
}
    ...
    <group>
      ...
      <group ref={inner}>
        <mesh position={[0, 0, 0.05]}>
          ...
          <meshStandardMaterial color="#3968c9" emissive="#16264d" emissiveIntensity={0.6} roughness={0.25} metalness={0.6} />
        </mesh>
      </group>
    </group>
  );
      ...
      {coins.map((i) => (
        <mesh key={i} position={[0, i * 0.32 - 0.5, 0]}>
          ...
          <meshStandardMaterial
            color={i % 2 === 0 ? "#3968c9" : "#e28b5c"}
            emissive={i % 2 === 0 ? "#16264d" : "#7a4a2e"}
    ...
    <div className="h-full w-full">
      <Canvas dpr={[1, 1.5]} camera={{ position: [0, 0, 3.4], fov: 40 }} gl={{ alpha: true }}>
        <Suspense fallback={null}>
          ...
          <pointLight position={[3, 3, 3]} intensity={1.3} color="#3968c9" />
